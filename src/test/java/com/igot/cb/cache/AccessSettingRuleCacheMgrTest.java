...
class AccessSettingRuleCacheMgrTest {
  ...
  void testGetOrLoadAccessSettingRule_cacheMiss_loadsFromCassandra() {
    ...
    assertEquals("Course", result.getContextIdType());
    @SuppressWarnings("unchecked")
    ArgumentCaptor<Map<String, Object>> captor = (ArgumentCaptor<Map<String, Object>>) (ArgumentCaptor<?>) ArgumentCaptor
        .forClass(Map.class);
    ...
    CachedAccessSettingRule cached = cacheMgr.getOrLoadAccessSettingRule("do_123", "Course");
  ...
  void testGetOrLoadAccessSettingRule_cacheMiss_noRecord() {
    ...
    CachedAccessSettingRule result = cacheMgr.getOrLoadAccessSettingRule("do_999", "Course");
  ...
  void testGetOrLoadAccessSettingRule_cassandraThrowsException() {
    ...
    CachedAccessSettingRule result = cacheMgr.getOrLoadAccessSettingRule("do_500", "Course");
