...
class VideoOnDemandKafkaConsumerTest {
    ...
    void test_content_metadata_update_consumer_processes_valid_json_message() throws Exception {
        ...
        ConsumerRecord<String, String> consumerRecord = new ConsumerRecord<>("test-topic", 0, 0L, "key",
                validJsonMessage);
        ...
        verify(mapper, timeout(100)).readValue(eq(validJsonMessage), any(TypeReference.class));
    }

    @Test
    void test_content_metadata_update_consumer_handles_blank_message_gracefully() throws Exception {
    ...
    void test_invalid_json_message_handling() throws Exception {
        ...
        verify(mapper, timeout(100)).readValue(eq(invalidJsonMessage), any(TypeReference.class));
        verify(outboundRequestHandlerService, never()).fetchResultUsingPatch(anyString(), any(), any());
    }
    ...
    void test_missing_required_fields() throws Exception {
        ...
        verify(mapper, timeout(100)).readValue(eq(messageWithMissingFields), any(TypeReference.class));
        verify(outboundRequestHandlerService, never()).fetchResultUsingPatch(anyString(), any(), any());
    }
    ...
    void test_api_call_failure() throws Exception {
        ...
        verify(outboundRequestHandlerService, timeout(100)).fetchResultUsingPatch(anyString(), any(), any());
    }
    ...
    void test_url_transformation() throws Exception {
        ...
        verify(outboundRequestHandlerService, timeout(100)).fetchResultUsingPatch(
